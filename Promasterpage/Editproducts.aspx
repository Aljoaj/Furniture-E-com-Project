<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Editproducts.aspx.cs" Inherits="Promasterpage.Editproducts" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating">
                        ...
                        <Columns>
                            ...
                            <asp:ImageField DataImageUrlField="Productphoto" HeaderText="Product Image">
